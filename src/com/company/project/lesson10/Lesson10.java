...
public class Lesson10 {
    public static void main(String[] args) {
        ...
        Item item01 = new Item("Книга", 240);
        Item item02 = new Item("Книга", 240);
        ...
        System.out.println(copy == order01); // false (== сравнение ссылок!!!)
        System.out.println(copy.getItems() == order01.getItems()); // false??? сравнение ссылок на массив
